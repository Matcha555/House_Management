 ...
 * @author Quang
 */
@WebServlet(name = "CreateAdminProductController", urlPatterns = {"/CreateAdminProductController"})
public class CreateAdminProductController extends HttpServlet {

    private static final String ERROR = "GetAllProAdmin.jsp";
...
//            }
            ...
            if (e.toString().contains("duplicate")) {
                proError.setProdIdError("Trung khoa roi kia, can tao moi lai!");
                request.setAttribute("PROD_ERROR", proError);
            }
