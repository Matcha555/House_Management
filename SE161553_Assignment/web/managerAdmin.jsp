            ...
            <div class="table-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <form action="MainController" method="post">
                                ...
                                <!--<input type="submit" class="btn btn-info add-new" name="action" value="Create new" /><i class="fa fa-plus"></i>-->
                                <!--<button type="button" class="btn btn-info add-new" name="action" value="Create New" ><i class="fa fa-plus"></i> </button>-->
                            </form>
                        </div>
                        <div class="col-sm-2">
                ...
                <c:if test="${requestScope.LIST_PRODUCT == null}"> 
                    <h3>Not found!!! Please search again.</h3>
                        ...
                        <a href="admin_2.jsp">Back to home page</a><br>
                        <a href="GetAllProductsAdmin">Show all products</a>
            </div>
        </div>        
    </div>     
</body>
