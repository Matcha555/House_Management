<!--Trang này trang chính (ch?a login)-->
<!doctype html>
<html lang="en">
    <head>
        <!-- Required meta tags -->
    ...
    <body>
                    ...
                    <header class="row">
                        ...
                        <div class="accounts col-lg-9 col-6">
                            <ul>
                                ...
                                <li class="top_li1"><a href="index_1.jsp" >Login</a></li>
                                <li class="top_li2"><a href="#">View Cart</a></li>
                            </ul>
                        </div>
        ...
        <section class="w3l-bootstrap-header">
            <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
                <div class="container">
                    <a class="navbar-brand" href="homePage.jsp"><span class="fa fa-home"></span> Estate Agent</a>
                        ...
                        <div class="column1">
                            ...
                            <form action="" method="Get">
                                <div class="blog-search form d-flex search-form">
                                    <input type="search" class="form-control" placeholder="Enter Location, Property, Landmark" name="search" >
