<!--Trang này trang chính (dã login) for admin -->
...
<section class="w3l-top-menu-1">
	...
	<header class="row">
		...
		<div class="accounts col-lg-9 col-6">
                    <ul>
                        <li class="top_li"><a href="#">Manage accounts</a></li>
                        <li class="top_li1"><a href="GetAllProductsAdmin">Manage products</a></li>
                        <li class="top_li2">
                        ...
                        <li class="top_li4"><a href="#">View Cart</a></li>
                    </ul>
		</div>
...
<section class="w3l-bootstrap-header">
  <nav class="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
    <div class="container">
      <a class="navbar-brand" href="admin_2.jsp"><span class="fa fa-home"></span> Estate Agent</a>
        ...
        turpis sodales quis. Integer sit amet mattis quam.</p>
            ...
            <div class="row mt-5 pt-3">
                <div class="grids4-info  col-lg-4 col-md-6">
                        ...
                        <div class="info-bg">
                            <h5><a href="#">Dan Bilzerian's bel air</a></h5>
                            <p>$100,000,000 - $200,000/month</p>
                            <ul>
